...
def get_price(token, uic, asset_type, base):
    ...
    last_traded = details.get("LastTraded")
    last_close  = details.get("LastClose")
    ...
    return {
        ...
        "day_open":        details.get("Open"),
        "day_high":        d.get("PriceInfo", {}).get("High"),
        "day_low":         d.get("PriceInfo", {}).get("Low"),
